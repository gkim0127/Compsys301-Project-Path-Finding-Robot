...
module top ;
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_313)
    begin
        cy_tff_1 <= Net_312^Net_314;
    end
    assign Net_314 = cy_tff_1;
    // -- TFF End --
