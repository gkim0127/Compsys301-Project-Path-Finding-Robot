...
module top ;
	...
	wire [0:0] tmpOE__ENCO4_net;
	wire [0:0] tmpIO_0__ENCO4_net;
	wire [0:0] tmpINTERRUPT_0__ENCO4_net;
	electrical [0:0] tmpSIOVREF__ENCO4_net;

	cy_psoc3_pins_v1_10
		#(.id("aa5bd760-3b31-440e-be8a-54e53a5c6321"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ENCO4
		 (.oe(tmpOE__ENCO4_net),
		  .y({1'b0}),
		  .fb({Net_669}),
		  .io({tmpIO_0__ENCO4_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCO4_net),
		  .interrupt({tmpINTERRUPT_0__ENCO4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCO4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ENCO3_net;
	wire [0:0] tmpIO_0__ENCO3_net;
	wire [0:0] tmpINTERRUPT_0__ENCO3_net;
	electrical [0:0] tmpSIOVREF__ENCO3_net;

	cy_psoc3_pins_v1_10
		#(.id("2ffe80b1-2521-47f7-88f5-54b655ac2d19"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ENCO3
		 (.oe(tmpOE__ENCO3_net),
		  .y({1'b0}),
		  .fb({Net_668}),
		  .io({tmpIO_0__ENCO3_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCO3_net),
		  .interrupt({tmpINTERRUPT_0__ENCO3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCO3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
