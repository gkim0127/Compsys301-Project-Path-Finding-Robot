...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("fb521fb9-3f53-4417-92d0-dca9dd48daff/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("628140703.517588"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_385),
...
module ADC_SAR_v3_10_4 (
	...
	cy_clock_v1_0
		#(.id("f19a73df-a3a9-41ed-94ec-f5766fc8aa6e/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("628140703.517588"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c192f4ae-255e-4ae4-a836-10808f066079"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7df48980-80c0-4353-bd5a-a06df1438b84"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("6954bb00-c004-48cb-b797-551030807ba0"),
		  .source_clock_id("CEF43CFB-0213-49b9-B980-2FFAB81C5B47"),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("97e7ea46-1e7d-4f55-80af-ca3bceae72dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
